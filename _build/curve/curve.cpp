...
void nurbs_curve::add_control_point( point inpoint ) {
...
void nurbs_curve::add_control_point( float inx, float iny, float inz ) {
    point temp_point(inx,iny,inz);
    add_control_point(temp_point);
}


void nurbs_curve::info() {
...
//------------------------------------------------------------	CoxDeBoor()
//
float nurbs_curve::CoxDeBoor(float u,int i,int k ) {
	if(k==1)
	{
...
//------------------------------------------------------------	GetOutpoint()
//
void nurbs_curve::GetOutpoint(float t,point *OutPoint ) {
